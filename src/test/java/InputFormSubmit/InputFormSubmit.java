...
public class InputFormSubmit {
	...
	public void setup(Method m, ITestContext ctx) throws MalformedURLException {
		...
		String authkey = System.getenv("LT_ACCESS_KEY") == null ? "4OEb0yWUPKGPxZM6PR8sZfFJLupEWdzGJCmaW5jnr1gzuhWy5G"
	...
	public void TestScenario3() throws InterruptedException {
		...
		WebElement successmessage = driver.findElement(
				...
				By.xpath("//div[@class='loginform mt-20 p-20']/p[@class='success-msg hidden']"));
						// "//div[@class='loginform border border-gray-90 mt-20 p-20']/p[@class='success-msg hidden']"));
